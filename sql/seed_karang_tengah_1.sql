...
insert into public.school_profile (
  ...
  profile_title,description,logo_url,hero_image_url,spmb_title,spmb_description,spmb_url
) values (
  1,
  'SDN Karang Tengah 1',
  '20607151',
  ...
  345,
  20,
  'Jalan Raden Saleh No. 118, Karang Tengah, Kecamatan Karang Tengah, Kota Tangerang, Banten 15157',
  'Kota Tangerang',
...
on conflict (id) do update set
  ...
  profile_title=excluded.profile_title,description=excluded.description,
